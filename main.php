...
<?php
	$total = $days = $hours = $minutes = $seconds = 0;
		...
		<div class="text-center">
			<div class="well well-sm col-md-12 col-sm-12 col-xs-12">
				<form id="setTimerForm" style="padding-top:15px;" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?>">
					...
					<div class="text-center">
						<label id="main_text" style="padding-bottom:10px; color:#c47868"><u>Enter Countdown Values</u></label> <br/>
					</div>
					<div class="col-md-3 col-sm-6">
						<label>Days</label>
						<input required class="form-control" type="number" maxlength="3" name="day" value="" placeholder="0-999">
					</div>
					<div class="col-md-3 col-sm-6">
						<label>Hours</label>
						<input required class="form-control" type="number" maxlength="2" name="hour" value="" placeholder="0-99">
					</div>
					<div class="col-md-3 col-sm-6">
						<label>Minutes</label>
						<input required class="form-control" type="number" maxlength="2" name="minute" value="" placeholder="0-99">
					</div>
					<div class="col-md-3 col-sm-6">
						<label>Seconds</label>
						<input required class="form-control" type="number" maxlength="2" name="second" value="" placeholder="0-99">
					</div>
